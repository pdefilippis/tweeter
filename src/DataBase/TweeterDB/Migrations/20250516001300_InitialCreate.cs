        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LasName = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFollows", x => new { x.FollowersUserId, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "LasName", "Name" },
                values: new object[] { 1, "De Filippis", "Pablo" });
